...
const PostPage: NextPage = () => {
  ...
  function handleImageResize() {
    if (document && document.getElementsByTagName("IMG")[0]) {
      ...
      let imageAspectRatio = (image as HTMLImageElement).naturalWidth / (image as HTMLImageElement).naturalHeight
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name={title?"Spacetagram | " + title: "Spacetagram"} content={description?description:"Image sharing platform built on NASA’s image APIs for Shopify's front end developer intern challenge"} />
      ...
      <main className={styles.main}>
          ...
          <div className={styles.rightWrapper}>
            ...
            <div className={styles.share} onClick={(e)=>{navigator.clipboard.writeText(window.location.href);setShareLinkCopied(true)}}>{shareLinkCopied?"link copied":<BiShareAlt/>}</div> 
